...
CREATE TABLE "Restaurants" (
    ...
    "cuisineType" TEXT DEFAULT 'other',
...
CREATE TABLE "RestaurantApplications" (
    ...
    "longitude" DOUBLE PRECISION,
    "cuisineType" TEXT DEFAULT 'other',
    "businessLicenseEnc" TEXT,
    "ownershipProofEnc" TEXT,
    "nationalIdEnc" TEXT,
    "nationalIdBackEnc" TEXT,
    ...
    CONSTRAINT "RestaurantApplications_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "RestaurantApplications_userId_idx" ON "RestaurantApplications"("userId");

-- CreateIndex
CREATE INDEX "RestaurantApplications_status_idx" ON "RestaurantApplications"("status");
...
-- AddForeignKey
ALTER TABLE "RestaurantApplications" ADD CONSTRAINT "RestaurantApplications_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RestaurantApplications" ADD CONSTRAINT "RestaurantApplications_reviewedBy_fkey" FOREIGN KEY ("reviewedBy") REFERENCES "Users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
